  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-30 flex w-64 flex-col bg-sidebar-bg">
      ...
      <div className="flex h-16 items-center gap-3 border-b border-sidebar-border px-5">
        ...
        <div>
          <h1 className="font-heading text-sm font-semibold text-white">KASIRSOLO</h1>
          <p className="text-[10px] text-sidebar-text">Control Center</p>
        </div>
      </div>
              ...
              <li key={item.href}>
                <Link
                  ...
                  className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors ${
                    active
                      ? "bg-sidebar-active text-brand-primary"
      ...
      <div className="border-t border-sidebar-border p-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="truncate text-xs text-sidebar-text">owner.kasirsolo@gmail.com</p>
          </div>
        </div>
      </div>
    </aside>
