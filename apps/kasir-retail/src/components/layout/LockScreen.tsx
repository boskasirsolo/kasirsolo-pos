...
// Retail price override (FNB uses default 350000)
    ...
    <div className="min-h-screen bg-brand-dark flex flex-col items-center justify-center p-6">
      <div className="text-center max-w-sm">
        ...
        <div className="bg-white/5 rounded-xl p-4 mb-6">
          <p className="text-sm text-gray-300 mb-1">Harga Lisensi {BRAND_NAME} Retail</p>
          <p className="text-2xl font-bold text-brand-accent">{formatRupiah(RETAIL_PRICE)}</p>
