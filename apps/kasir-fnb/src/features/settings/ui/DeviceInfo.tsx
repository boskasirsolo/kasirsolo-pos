    ...
    <div className="space-y-4">
      <div className="bg-white rounded-xl border border-pos-border p-4 space-y-2">
        ...
        <div className="flex justify-between text-sm">
          ...
          <span
            className={`font-medium ${licenseStatus?.valid ? 'text-green-600' : 'text-red-500'}`}
          >
      ...
      <div className="bg-white rounded-xl border border-pos-border p-4">
        ...
        <p className="text-xs text-gray-500 mb-4">
          KASIRSOLO F&B adalah aplikasi kasir offline-first untuk bisnis Food & Beverage. Dibuat
          oleh PT Mesin Kasir Solo.
        </p>
